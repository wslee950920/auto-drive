...
def ar_callback(msg):
	...
	for i in msg.markers:
		...
		elif (prevId==5 or prevId==6) and i.id==9:
			ar_flag=9

		elif prevId==9 and i.id==0:
			ar_flag=0
...
def yolo_main():
	...
	if not yolo_flag:
		...
		if distance<1.8:
			...
			prevId=ar_flag
			#print('prev', prevId, 'ar_flag', ar_flag)
